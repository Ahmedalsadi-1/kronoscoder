...
export const dict = {
  ...
  "notFound.title": "غير موجود | kronoscode",
  ...
  "home.title": "KronosCode | وكيل برمجة بالذكاء الاصطناعي مفتوح المصدر",

  "temp.title": "kronoscode | وكيل برمجة بالذكاء الاصطناعي مبني للطرفية",
  ...
  "temp.feature.zen.afterLink": "مقدمة من kronoscode",
  "temp.feature.models.beforeLink": "يدعم أكثر من 75 مزود LLM من خلال",
  "temp.feature.models.afterLink": "، بما في ذلك النماذج المحلية",
  "temp.screenshot.caption": "واجهة KronosCode الطرفية مع سمة tokyonight",
  "temp.screenshot.alt": "واجهة KronosCode الطرفية بسمة tokyonight",
  ...
  "home.what.title": "ما هو KronosCode؟",
  "home.what.body": "KronosCode وكيل مفتوح المصدر يساعدك على كتابة الكود في الطرفية، IDE، أو سطح المكتب.",
  ...
  "home.growth.body":
    "مع أكثر من <strong>{{stars}}</strong> نجمة على GitHub، و<strong>{{contributors}}</strong> مساهمًا، وأكثر من <strong>{{commits}}</strong> Commit، يستخدم KronosCode ويثق به أكثر من <strong>{{monthlyUsers}}</strong> مطوّر كل شهر.",
  ...
  "home.privacy.body": "لا يخزّن KronosCode أي كود أو بيانات سياق، ليتمكن من العمل في بيئات حساسة للخصوصية.",
  "home.privacy.learnMore": "اعرف المزيد عن",
  "home.privacy.link": "الخصوصية",

  "home.faq.q1": "ما هو KronosCode؟",
  "home.faq.a1":
    "KronosCode وكيل مفتوح المصدر يساعدك على كتابة وتشغيل الكود مع أي نموذج ذكاء اصطناعي. متاح كواجهة طرفية، وتطبيق سطح مكتب، أو امتداد IDE.",
  "home.faq.q2": "كيف أستخدم KronosCode؟",
  "home.faq.a2.before": "أسهل طريقة للبدء هي قراءة",
  "home.faq.a2.link": "المقدمة",
  "home.faq.q3": "هل أحتاج لاشتراكات ذكاء اصطناعي إضافية لاستخدام KronosCode؟",
  "home.faq.a3.p1":
    "ليس بالضرورة، فـ KronosCode يأتي مع مجموعة من النماذج المجانية التي تستطيع استخدامها دون إنشاء حساب.",
  "home.faq.a3.p2.beforeZen": "وبخلاف ذلك، يمكنك استخدام أي من نماذج البرمجة الشائعة بإنشاء حساب",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "مع أننا نشجّع المستخدمين على استخدام Zen، فإن KronosCode يعمل أيضًا مع كل المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",
  "home.faq.a3.p4.beforeLocal": "ويمكنك أيضًا ربط",
  "home.faq.a3.p4.localLink": "النماذج المحلية",
  "home.faq.q4": "هل يمكنني استخدام اشتراكاتي الحالية مع KronosCode؟",
  "home.faq.a4.p1":
    "نعم، يدعم KronosCode خطط الاشتراك من كل المزودين الرئيسيين. يمكنك استخدام اشتراكات Claude Pro/Max، ChatGPT Plus/Pro، أو GitHub Copilot.",
  "home.faq.q5": "هل يمكنني استخدام KronosCode في الطرفية فقط؟",
  "home.faq.a5.beforeDesktop": "ليس بعد الآن! KronosCode متاح الآن كتطبيق لـ",
  "home.faq.a5.desktop": "سطح المكتب",
  "home.faq.a5.and": "و",
  "home.faq.a5.web": "الويب",
  "home.faq.q6": "كم تكلفة KronosCode؟",
  "home.faq.a6":
    "KronosCode مجاني 100% للاستخدام. كما يأتي مع مجموعة من النماذج المجانية. قد توجد تكاليف إضافية إذا ربطت مزوّدًا آخر.",
  ...
  "home.faq.q8": "هل KronosCode مفتوح المصدر؟",
  "home.faq.a8.p1": "نعم، KronosCode مفتوح المصدر بالكامل. الكود المصدري متاح علنًا على",
  ...
  "home.zenCta.body":
    "يمنحك Zen الوصول إلى مجموعة مختارة بعناية من نماذج الذكاء الاصطناعي التي اختبرها KronosCode وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة بين المزودين، استخدم نماذج محققة تعمل بكفاءة.",
  "home.zenCta.link": "تعرف على Zen",

  "zen.title": "KronosCode Zen | مجموعة منسقة من النماذج المحسنة والموثوقة لوكلاء البرمجة",
  "zen.hero.title": "نماذج محسنة وموثوقة لوكلاء البرمجة",
  "zen.hero.body":
    "يمنحك Zen الوصول إلى مجموعة منسقة من نماذج الذكاء الاصطناعي التي اختبرها KronosCode وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة، استخدم نماذج محققة تعمل بكفاءة.",

  "zen.faq.q1": "ما هو KronosCode Zen؟",
  "zen.faq.a1":
    "Zen هو مجموعة منسقة من نماذج الذكاء الاصطناعي التي تم اختبارها وقياس أدائها لوكلاء البرمجة، أنشأها الفريق المطور لـ KronosCode.",
  ...
  "zen.faq.a3":
    "Zen ليس للربح. يمرر Zen التكاليف من مزودي النماذج إليك مباشرة. كلما زاد استخدام Zen، تمكن KronosCode من التفاوض على أسعار أفضل وتمريرها إليك.",
  ...
  "zen.faq.a4.p3":
    "لتغطية التكاليف، يضيف KronosCode فقط رسومًا صغيرة لمعالجة الدفع قدرها 1.23 دولار لكل إعادة شحن رصيد بقيمة 20 دولارًا.",
  ...
  "zen.faq.a8":
    "بينما يعمل Zen بشكل رائع مع KronosCode، يمكنك استخدام Zen مع أي وكيل. اتبع تعليمات الإعداد في وكيل البرمجة المفضل لديك.",
  ...
  "zen.problem.subtitle": "نحن نعمل على إصلاح هذا للجميع، وليس فقط لمستخدمي KronosCode.",
  ...
  "zen.how.body": "بينما نقترح عليك استخدام Zen مع KronosCode، يمكنك استخدام Zen مع أي وكيل.",
  ...
  "black.meta.title": "KronosCode Black | الوصول إلى أفضل نماذج البرمجة في العالم",
  "black.meta.description": "احصل على وصول إلى Claude، GPT، Gemini والمزيد مع خطط اشتراك KronosCode Black.",
  "black.hero.title": "الوصول إلى أفضل نماذج البرمجة في العالم",
  "black.hero.subtitle": "بما في ذلك Claude، GPT، Gemini والمزيد",
  "black.title": "KronosCode Black | الأسعار",
  ...
  "black.workspace.title": "KronosCode Black | اختر مساحة العمل",
  "black.workspace.selectPlan": "اختر مساحة عمل لهذه الخطة",
  "black.workspace.name": "مساحة العمل {{n}}",
  "black.subscribe.title": "اشترك في KronosCode Black",
  ...
  "black.subscribe.success.title": "أنت في قائمة انتظار KronosCode Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "استخدم Zen مع أي وكيل برمجة، واستمر في استخدام موفرين آخرين مع kronoscode وقتما تشاء.",
  ...
  "workspace.newUser.step.login.after": "واختر kronoscode",
  "workspace.newUser.step.pasteKey": "الصق مفتاح API الخاص بك",
  "workspace.newUser.step.models.before": "ابدأ kronoscode ثم نفّذ",
  ...
  "workspace.keys.subtitle": "إدارة مفاتيح API الخاصة بك للوصول إلى خدمات kronoscode.",
  "workspace.keys.create": "إنشاء مفتاح API",
  "workspace.keys.placeholder": "أدخل اسم المفتاح",
  "workspace.keys.empty": "أنشئ مفتاح API لبوابة kronoscode",
  ...
  "workspace.black.subscription.message": "أنت مشترك في KronosCode Black مقابل ${{plan}} شهريًا.",
  ...
  "workspace.black.waitlist.joined": "أنت في قائمة الانتظار لخطة KronosCode Black بقيمة ${{plan}} شهريًا.",
  "workspace.black.waitlist.ready": "نحن مستعدون لتسجيلك في خطة KronosCode Black بقيمة ${{plan}} شهريًا.",
  ...
  "download.title": "KronosCode | تنزيل",
  "download.meta.description": "نزّل KronosCode لـ macOS، Windows، وLinux",
  "download.hero.title": "تنزيل KronosCode",
  "download.hero.subtitle": "متاح في نسخة تجريبية لـ macOS، Windows، وLinux",
  "download.hero.button": "تنزيل لـ {{os}}",
  "download.section.terminal": "KronosCode للطرفية",
  "download.section.desktop": "KronosCode لسطح المكتب (Beta)",
  "download.section.extensions": "امتدادات KronosCode",
  "download.section.integrations": "تكاملات KronosCode",
  ...
  "download.faq.a3.beforeLocal":
    "ليس بالضرورة، ولكن على الأرجح. ستحتاج إلى اشتراك ذكاء اصطناعي إذا كنت تريد ربط KronosCode بمزوّد مدفوع، رغم أنه يمكنك العمل مع",
  "download.faq.a3.localLink": "النماذج المحلية",
  "download.faq.a3.afterLocal.beforeZen": "مجانًا. بينما نشجع المستخدمين على استخدام",
  "download.faq.a3.afterZen": "، فإن KronosCode يعمل مع جميع المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",

  "download.faq.a5.p1": "KronosCode مجاني 100% للاستخدام.",
  "download.faq.a5.p2.beforeZen":
    "أي تكاليف إضافية ستأتي من اشتراكك لدى مزود النماذج. بينما يعمل KronosCode مع أي مزود نماذج، نوصي باستخدام",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "يتم حفظ بياناتك ومعلوماتك فقط عند إنشاء روابط قابلة للمشاركة في KronosCode.",
  "download.faq.a6.p2.beforeShare": "اعرف المزيد عن",
  "download.faq.a6.shareLink": "صفحات المشاركة",

  "enterprise.title": "KronosCode | حلول المؤسسات لمنظمتك",
  "enterprise.meta.description": "تواصل مع KronosCode لحلول المؤسسات",
  "enterprise.hero.title": "كودك ملكك",
  "enterprise.hero.body1":
    "يعمل KronosCode بأمان داخل مؤسستك دون تخزين أي بيانات أو سياق، ودون قيود ترخيص أو مطالبات ملكية. ابدأ تجربة مع فريقك، ثم انشره عبر مؤسستك من خلال دمجه مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  ...
  "enterprise.faq.q1": "ما هو KronosCode Enterprise؟",
  "enterprise.faq.a1":
    "KronosCode Enterprise مخصص للمؤسسات التي تريد التأكد من أن الكود والبيانات لا تغادر بنيتها التحتية أبدًا. يتحقق ذلك عبر استخدام تكوين مركزي يندمج مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  "enterprise.faq.q2": "كيف أبدأ مع KronosCode Enterprise؟",
  "enterprise.faq.a2":
    "ابدأ ببساطة بتجربة داخلية مع فريقك. افتراضيًا، لا يقوم KronosCode بتخزين الكود أو بيانات السياق، مما يجعل البدء سهلاً. ثم اتصل بنا لمناقشة الأسعار وخيارات التنفيذ.",
  ...
  "enterprise.faq.q4": "هل بياناتي آمنة مع KronosCode Enterprise؟",
  "enterprise.faq.a4":
    "نعم. لا يقوم KronosCode بتخزين الكود أو بيانات السياق. تتم جميع المعالجة محليًا أو عبر استدعاءات API مباشرة إلى مزود الذكاء الاصطناعي لديك. مع التكوين المركزي وتكامل SSO، تظل بياناتك آمنة داخل البنية التحتية لمؤسستك.",

  "brand.title": "KronosCode | العلامة التجارية",
  "brand.meta.description": "إرشادات العلامة التجارية لـ KronosCode",
  "brand.heading": "إرشادات العلامة التجارية",
  "brand.subtitle": "موارد وأصول لمساعدتك في العمل مع العلامة التجارية لـ KronosCode.",
  "brand.downloadAll": "تنزيل جميع الأصول",

  "changelog.title": "KronosCode | سجل التغييرات",
  "changelog.meta.description": "ملاحظات الإصدار وسجل التغييرات لـ KronosCode",
  "changelog.hero.title": "سجل التغييرات",
  "changelog.hero.subtitle": "تحديثات وتحسينات جديدة لـ KronosCode",
