export const dict = {
  ...
  "notFound.title": "Not Found | kronoscode",
  ...
  "home.title": "KronosCode | The open source AI coding agent",

  "temp.title": "kronoscode | AI coding agent built for the terminal",
  ...
  "temp.feature.zen.afterLink": "provided by kronoscode",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "kronoscode TUI with the tokyonight theme",
  "temp.screenshot.alt": "kronoscode TUI with tokyonight theme",
  ...
  "home.what.title": "What is KronosCode?",
  "home.what.body": "KronosCode is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, KronosCode is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "KronosCode does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is KronosCode?",
  "home.faq.a1":
    "KronosCode is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use KronosCode?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use KronosCode?",
  "home.faq.a3.p1":
    "Not necessarily, KronosCode comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, KronosCode also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with KronosCode?",
  "home.faq.a4.p1":
    "Yes, KronosCode supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use KronosCode in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! KronosCode is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does KronosCode cost?",
  "home.faq.a6":
    "KronosCode is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is KronosCode open source?",
  "home.faq.a8.p1": "Yes, KronosCode is fully open source. The source code is public on",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that KronosCode has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  "home.zenCta.link": "Learn about Zen",

  "zen.title": "KronosCode Zen | A curated set of reliable optimized models for coding agents",
  "zen.hero.title": "Reliable optimized models for coding agents",
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that KronosCode has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is KronosCode Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind KronosCode.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more KronosCode can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a4.p3": "To cover costs, KronosCode adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "zen.faq.a8":
    "While Zen works great with KronosCode, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just KronosCode users.",
  ...
  "zen.how.body": "While we suggest you use Zen with KronosCode, you can use Zen with any agent.",
  ...
  "black.meta.title": "KronosCode Black | Access all the world's best coding models",
  "black.meta.description": "Get access to Claude, GPT, Gemini and more with KronosCode Black subscription plans.",
  "black.hero.title": "Access all the world's best coding models",
  "black.hero.subtitle": "Including Claude, GPT, Gemini and more",
  "black.title": "KronosCode Black | Pricing",
  ...
  "black.workspace.title": "KronosCode Black | Select Workspace",
  "black.workspace.selectPlan": "Select a workspace for this plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Subscribe to KronosCode Black",
  ...
  "black.subscribe.success.title": "You're on the KronosCode Black waitlist",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with kronoscode whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select kronoscode",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start kronoscode and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing kronoscode services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an kronoscode Gateway API key",
  ...
  "workspace.black.subscription.message": "You are subscribed to KronosCode Black for ${{plan}} per month.",
  ...
  "workspace.black.waitlist.joined": "You are on the waitlist for the ${{plan}} per month KronosCode Black plan.",
  "workspace.black.waitlist.ready": "We're ready to enroll you into the ${{plan}} per month KronosCode Black plan.",
  ...
  "download.meta.description": "Download KronosCode for macOS, Windows, and Linux",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect KronosCode to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", KronosCode works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "KronosCode is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While KronosCode works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in KronosCode.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "KronosCode | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact KronosCode for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "KronosCode operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.q1": "What is KronosCode Enterprise?",
  "enterprise.faq.a1":
    "KronosCode Enterprise is for organizations that want to ensure that their code and data never leaves their infrastructure. It can do this by using a centralized config that integrates with your SSO and internal AI gateway.",
  "enterprise.faq.q2": "How do I get started with KronosCode Enterprise?",
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. KronosCode by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "enterprise.faq.q4": "Is my data secure with KronosCode Enterprise?",
  "enterprise.faq.a4":
    "Yes. KronosCode does not store your code or context data. All processing happens locally or through direct API calls to your AI provider. With central config and SSO integration, your data remains secure within your organization's infrastructure.",

  "brand.title": "KronosCode | Brand",
  "brand.meta.description": "KronosCode brand guidelines",
  "brand.heading": "Brand guidelines",
  "brand.subtitle": "Resources and assets to help you work with the KronosCode brand.",
  "brand.downloadAll": "Download all assets",

  "changelog.title": "KronosCode | Changelog",
  "changelog.meta.description": "KronosCode release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to KronosCode",
