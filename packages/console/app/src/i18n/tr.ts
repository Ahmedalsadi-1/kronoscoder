...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | kronoscode",
  ...
  "home.title": "KronosCode | Açık kaynaklı yapay zeka kodlama ajanı",

  "temp.title": "kronoscode | Terminal için geliştirilmiş yapay zeka kodlama ajanı",
  ...
  "temp.feature.zen.beforeLink": "kronoscode tarafından sağlanan ",
  ...
  "temp.screenshot.caption": "kronoscode TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı kronoscode TUI",
  ...
  "home.what.title": "KronosCode nedir?",
  "home.what.body":
    "KronosCode, terminalinizde, IDE'nizde veya masaüstünde kod yazmanıza yardım eden açık kaynaklı bir ajandır.",
  ...
  "home.growth.body":
    "GitHub'da <strong>{{stars}}</strong>+ yıldız, <strong>{{contributors}}</strong> katılımcı ve <strong>{{commits}}</strong>+ commit ile KronosCode, her ay <strong>{{monthlyUsers}}</strong>+ geliştirici tarafından kullanılıyor ve güveniliyor.",
  ...
  "home.privacy.body":
    "KronosCode kodunuzu veya bağlam verilerinizi saklamaz; bu sayede gizliliğe duyarlı ortamlarda çalışabilir.",
  "home.privacy.learnMore": "Hakkında daha fazla bilgi:",
  "home.privacy.link": "gizlilik",

  "home.faq.q1": "KronosCode nedir?",
  "home.faq.a1":
    "KronosCode, herhangi bir AI modeliyle kod yazmanıza ve çalıştırmanıza yardım eden açık kaynaklı bir ajandır. Terminal arayüzü, masaüstü uygulaması veya IDE uzantısı olarak kullanılabilir.",
  "home.faq.q2": "KronosCode'u nasıl kullanırım?",
  "home.faq.a2.before": "Başlamanın en kolay yolu",
  "home.faq.a2.link": "girişi okumaktır",
  "home.faq.q3": "KronosCode için ek AI aboneliklerine ihtiyacım var mı?",
  "home.faq.a3.p1": "Şart değil. KronosCode, hesap açmadan kullanabileceğiniz ücretsiz modellerle gelir.",
  ...
  "home.faq.a3.p3": "Zen'i öneriyoruz, ancak KronosCode OpenAI, Anthropic, xAI gibi popüler sağlayıcılarla da çalışır.",
  "home.faq.a3.p4.beforeLocal": "Hatta",
  "home.faq.a3.p4.localLink": "yerel modellerinizi",
  "home.faq.q4": "Mevcut AI aboneliklerimi KronosCode ile kullanabilir miyim?",
  "home.faq.a4.p1":
    "Evet. KronosCode tüm büyük sağlayıcıların aboneliklerini destekler. Claude Pro/Max, ChatGPT Plus/Pro veya GitHub Copilot kullanabilirsiniz.",
  "home.faq.q5": "KronosCode'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artık hayır! KronosCode şimdi",
  "home.faq.a5.desktop": "masaüstü",
  "home.faq.a5.and": "ve",
  "home.faq.a5.web": "web",
  "home.faq.q6": "KronosCode ne kadar?",
  "home.faq.a6":
    "KronosCode %100 ücretsizdir. Ayrıca ücretsiz model setiyle gelir. Başka bir sağlayıcı bağlarsanız ek maliyetler olabilir.",
  ...
  "home.faq.q8": "KronosCode açık kaynak mı?",
  "home.faq.a8.p1": "Evet, KronosCode tamamen açık kaynaktır. Kaynak kodu",
  ...
  "home.zenCta.body":
    "Zen, KronosCode'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",
  "home.zenCta.link": "Zen hakkında",

  "zen.title": "KronosCode Zen | Kodlama ajanları için güvenilir, optimize edilmiş modellerin seçilmiş seti",
  "zen.hero.title": "Kodlama ajanları için güvenilir, optimize modeller",
  "zen.hero.body":
    "Zen, KronosCode'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",

  "zen.faq.q1": "KronosCode Zen nedir?",
  "zen.faq.a1":
    "Zen, KronosCode ekibi tarafından oluşturulan ve kodlama ajanları için test edilip benchmark edilen seçilmiş bir AI model setidir.",
  ...
  "zen.faq.a3":
    "Zen kâr amaçlı değildir. Zen, model sağlayıcılarının maliyetlerini size yansıtır. Zen'in kullanımı arttıkça KronosCode daha iyi fiyatlar pazarlayabilir ve bunları size yansıtabilir.",
  ...
  "zen.faq.a4.p3":
    "Maliyetleri karşılamak için KronosCode, $20 bakiye yüklemesi başına yalnızca $1.23 tutarında küçük bir ödeme işleme ücreti ekler.",
  ...
  "zen.faq.a8":
    "Zen KronosCode ile harika çalışır, ama Zen'i herhangi bir ajan ile kullanabilirsiniz. Tercih ettiğiniz kodlama ajanında kurulum talimatlarını izleyin.",
  ...
  "zen.problem.subtitle": "Bu sorunu yalnızca KronosCode kullanıcıları için değil, herkes için düzeltiyoruz.",
  ...
  "zen.how.body": "Zen'i KronosCode ile kullanmanızı önersek de, Zen'i herhangi bir ajan ile kullanabilirsiniz.",
  ...
  "black.meta.title": "KronosCode Black | Dünyanın en iyi kodlama modellerine erişin",
  "black.meta.description": "KronosCode Black abonelik planlarıyla Claude, GPT, Gemini ve daha fazlasına erişin.",
  "black.hero.title": "Dünyanın en iyi kodlama modellerine erişin",
  "black.hero.subtitle": "Claude, GPT, Gemini ve daha fazlası dahil",
  "black.title": "KronosCode Black | Fiyatlandırma",
  ...
  "black.workspace.title": "KronosCode Black | Çalışma Alanı Seç",
  "black.workspace.selectPlan": "Bu plan için bir çalışma alanı seçin",
  "black.workspace.name": "Çalışma Alanı {{n}}",
  "black.subscribe.title": "KronosCode Black'e Abone Ol",
  ...
  "black.subscribe.success.title": "KronosCode Black bekleme listesindesiniz",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman kronoscode ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve kronoscode seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "kronoscode'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "kronoscode hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir kronoscode Gateway API anahtarı oluşturun",
  ...
  "workspace.black.subscription.message": "Aylık ${{plan}} karşılığında KronosCode Black'e abonesiniz.",
  ...
  "workspace.black.waitlist.joined": "Aylık ${{plan}} KronosCode Black planı için bekleme listesindesiniz.",
  "workspace.black.waitlist.ready": "Sizi ayda {{plan}} $ tutarındaki KronosCode Black planına kaydetmeye hazırız.",
  ...
  "download.title": "KronosCode | İndir",
  "download.meta.description": "KronosCode'u macOS, Windows ve Linux için indirin",
  "download.hero.title": "KronosCode'u İndir",
  ...
  "download.section.extensions": "KronosCode Eklentileri",
  "download.section.integrations": "KronosCode Entegrasyonları",
  ...
  "download.faq.a3.beforeLocal":
    "Tam olarak değil, ama muhtemelen. KronosCode'u ücretli bir sağlayıcıya bağlamak istiyorsanız bir AI aboneliği gerekir, ancak",
  ...
  "download.faq.a3.afterZen":
    " kullanmaya teşvik ediyoruz, ancak KronosCode OpenAI, Anthropic, xAI vb. gibi tüm popüler sağlayıcılarla çalışır.",

  "download.faq.a5.p1": "KronosCode %100 ücretsizdir.",
  "download.faq.a5.p2.beforeZen":
    "Ek maliyetler, bir model sağlayıcısına olan aboneliğinizden gelir. KronosCode herhangi bir model sağlayıcısıyla çalışır, ancak",
  "download.faq.a5.p2.afterZen": " kullanmanızı öneririz.",

  "download.faq.a6.p1":
    "Verileriniz ve bilginiz yalnızca KronosCode'da paylaşılabilir bağlantılar oluşturduğunuzda saklanır.",
  "download.faq.a6.p2.beforeShare": "Daha fazla bilgi:",
  "download.faq.a6.shareLink": "paylaşım sayfaları",

  "enterprise.title": "KronosCode | Kurumunuz için kurumsal çözümler",
  "enterprise.meta.description": "Kurumsal çözümler için KronosCode ile iletişime geçin",
  "enterprise.hero.title": "Kodunuz size aittir",
  "enterprise.hero.body1":
    "KronosCode, hiçbir veri veya bağlam saklamadan ve lisans kısıtlamaları ya da sahiplik iddiaları olmadan kuruluşunuzun içinde güvenli şekilde çalışır. Ekibinizle bir deneme başlatın, ardından SSO'nuz ve dahili AI geçidiniz ile entegre ederek tüm kuruluşunuzda devreye alın.",
  ...
  "enterprise.faq.q1": "KronosCode Enterprise nedir?",
  "enterprise.faq.a1":
    "KronosCode Enterprise, kodunuzun ve verilerinizin asla altyapınızı terk etmemesini sağlamak isteyen kurumlar içindir. Bunu, SSO'nuz ve dahili AI geçidiniz ile entegre olan merkezileştirilmiş bir konfigürasyonla sağlar.",
  "enterprise.faq.q2": "KronosCode Enterprise'a nasıl başlarım?",
  "enterprise.faq.a2":
    "Ekibinizle dahili bir deneme ile başlayın. KronosCode varsayılan olarak kodunuzu veya bağlam verilerinizi saklamaz, bu da başlamayı kolaylaştırır. Ardından fiyatlandırma ve uygulama seçeneklerini görüşmek için bize ulaşın.",
  ...
  "enterprise.faq.q4": "KronosCode Enterprise ile verilerim güvende mi?",
  "enterprise.faq.a4":
    "Evet. KronosCode kodunuzu veya bağlam verilerinizi saklamaz. Tüm işleme yerel olarak ya da AI sağlayıcınıza doğrudan API çağrıları ile gerçekleştirilir. Merkezileştirilmiş konfigürasyon ve SSO entegrasyonu ile verileriniz kurumunuzun altyapısı içinde güvende kalır.",

  "brand.title": "KronosCode | Marka",
  "brand.meta.description": "KronosCode marka kılavuzu",
  "brand.heading": "Marka kılavuzu",
  "brand.subtitle": "KronosCode markası ile çalışmanıza yardımcı olacak kaynaklar ve varlıklar.",
  "brand.downloadAll": "Tüm varlıkları indir",

  "changelog.title": "KronosCode | Değişiklik günlüğü",
  "changelog.meta.description": "KronosCode sürüm notları ve değişiklik günlüğü",
  "changelog.hero.title": "Değişiklik günlüğü",
  "changelog.hero.subtitle": "KronosCode için yeni güncellemeler ve iyileştirmeler",
