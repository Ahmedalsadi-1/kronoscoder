...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | kronoscode",
  ...
  "home.title": "KronosCode | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "kronoscode | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av kronoscode",
  ...
  "temp.screenshot.caption": "kronoscode TUI med tokyonight-tema",
  "temp.screenshot.alt": "kronoscode TUI med tokyonight-tema",
  ...
  "home.what.title": "Hva er KronosCode?",
  "home.what.body": "KronosCode er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes KronosCode av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "KronosCode lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er KronosCode?",
  "home.faq.a1":
    "KronosCode er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg KronosCode?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke KronosCode?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. KronosCode kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men KronosCode fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med KronosCode?",
  "home.faq.a4.p1":
    "Ja, KronosCode støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke KronosCode i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! KronosCode er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster KronosCode?",
  "home.faq.a6":
    "KronosCode er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er KronosCode åpen kildekode?",
  "home.faq.a8.p1": "Ja, KronosCode er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som KronosCode har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "zen.title": "KronosCode Zen | Et kuratert sett med pålitelige, optimaliserte modeller for kodeagenter",
  "zen.hero.title": "Pålitelige optimaliserte modeller for kodeagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som KronosCode har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er KronosCode Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak KronosCode.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan KronosCode forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger KronosCode til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med KronosCode, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare KronosCode-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med KronosCode, kan du bruke Zen med hvilken som helst agent.",
  ...
  "black.meta.title": "KronosCode Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med KronosCode Black-abonnementer.",
  "black.hero.title": "Få tilgang til verdens beste kodemodeller",
  "black.hero.subtitle": "Inkludert Claude, GPT, Gemini og mer",
  "black.title": "KronosCode Black | Priser",
  ...
  "black.workspace.title": "KronosCode Black | Velg arbeidsområde",
  "black.workspace.selectPlan": "Velg et arbeidsområde for denne planen",
  "black.workspace.name": "Arbeidsområde {{n}}",
  "black.subscribe.title": "Abonner på KronosCode Black",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for KronosCode Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med kronoscode når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg kronoscode",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start kronoscode og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til kronoscode-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en kronoscode Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på KronosCode Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for KronosCode Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på KronosCode Black-planen til ${{plan}} per måned.",
  ...
  "download.title": "KronosCode | Last ned",
  "download.meta.description": "Last ned KronosCode for macOS, Windows og Linux",
  "download.hero.title": "Last ned KronosCode",
  ...
  "download.section.extensions": "KronosCode Extensions",
  "download.section.integrations": "KronosCode Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble KronosCode til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer KronosCode med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "KronosCode er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om KronosCode fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i KronosCode.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "KronosCode | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt KronosCode for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "KronosCode opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er KronosCode Enterprise?",
  "enterprise.faq.a1":
    "KronosCode Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med KronosCode Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. KronosCode lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med KronosCode Enterprise?",
  "enterprise.faq.a4":
    "Ja. KronosCode lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "KronosCode | Merkevare",
  "brand.meta.description": "KronosCode retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med KronosCode-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "KronosCode | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for KronosCode",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for KronosCode",
