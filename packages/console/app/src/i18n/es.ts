...
export const dict = {
  ...
  "notFound.title": "No encontrado | kronoscode",
  ...
  "home.title": "KronosCode | El agente de codificación IA de código abierto",

  "temp.title": "kronoscode | Agente de codificación IA creado para la terminal",
  "temp.hero.title": "El agente de codificación IA creado para la terminal",
  "temp.zen": "kronoscode zen",
  ...
  "temp.feature.zen.afterLink": "proporcionada por kronoscode",
  ...
  "temp.screenshot.caption": "kronoscode TUI con el tema tokyonight",
  "temp.screenshot.alt": "kronoscode TUI con tema tokyonight",
  ...
  "home.what.title": "¿Qué es KronosCode?",
  "home.what.body":
    "KronosCode es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, KronosCode es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "KronosCode no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es KronosCode?",
  "home.faq.a1":
    "KronosCode es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso KronosCode?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar KronosCode?",
  "home.faq.a3.p1":
    "No necesariamente, KronosCode viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, KronosCode también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con KronosCode?",
  "home.faq.a4.p1":
    "Sí, KronosCode soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar KronosCode en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! KronosCode ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta KronosCode?",
  "home.faq.a6":
    "KronosCode es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es KronosCode de código abierto?",
  "home.faq.a8.p1": "Sí, KronosCode es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que KronosCode ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "KronosCode Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que KronosCode ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es KronosCode Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de KronosCode.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá KronosCode negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, KronosCode añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con KronosCode, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de KronosCode.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con KronosCode, puedes usar Zen con cualquier agente.",
  ...
  "black.meta.title": "KronosCode Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de KronosCode Black.",
  ...
  "black.title": "KronosCode Black | Precios",
  ...
  "black.workspace.title": "KronosCode Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a KronosCode Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de KronosCode Black",
  "black.subscribe.success.subscriptionPlan": "Plan de suscripción",
  "black.subscribe.success.planName": "KronosCode Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con kronoscode cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona kronoscode",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia kronoscode y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de kronoscode.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de kronoscode Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a KronosCode Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan KronosCode Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan KronosCode Black de ${{plan}} al mes.",
  ...
  "download.title": "KronosCode | Descargar",
  "download.meta.description": "Descarga KronosCode para macOS, Windows y Linux",
  "download.hero.title": "Descargar KronosCode",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "KronosCode Terminal",
  "download.section.desktop": "KronosCode Desktop (Beta)",
  "download.section.extensions": "Extensiones KronosCode",
  "download.section.integrations": "Integraciones KronosCode",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar KronosCode a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", KronosCode funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "KronosCode es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque KronosCode funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en KronosCode.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "KronosCode | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a KronosCode para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "KronosCode opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es KronosCode Enterprise?",
  "enterprise.faq.a1":
    "KronosCode Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con KronosCode Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. KronosCode por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con KronosCode Enterprise?",
  "enterprise.faq.a4":
    "Sí. KronosCode no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "KronosCode | Marca",
  "brand.meta.description": "Guías de marca de KronosCode",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca KronosCode.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "KronosCode | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de KronosCode",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para KronosCode",
