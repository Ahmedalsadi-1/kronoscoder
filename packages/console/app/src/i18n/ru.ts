...
export const dict = {
  ...
  "notFound.title": "Не найдено | kronoscode",
  ...
  "home.title": "KronosCode | AI-агент с открытым кодом для программирования",

  "temp.title": "kronoscode | AI-агент для программирования в терминале",
  ...
  "temp.feature.zen.afterLink": "от kronoscode",
  ...
  "temp.screenshot.caption": "KronosCode TUI с темой tokyonight",
  "temp.screenshot.alt": "KronosCode TUI с темой tokyonight",
  ...
  "home.what.title": "Что такое KronosCode?",
  "home.what.body":
    "KronosCode — это агент с открытым исходным кодом, который помогает писать код в терминале, IDE или на десктопе.",
  ...
  "home.growth.body":
    "С более чем <strong>{{stars}}</strong> звезд на GitHub, <strong>{{contributors}}</strong> контрибьюторов и <strong>{{commits}}</strong> коммитов, KronosCode доверяют более <strong>{{monthlyUsers}}</strong> разработчиков ежемесячно.",
  ...
  "home.privacy.body":
    "KronosCode не хранит ваш код или контекстные данные, поэтому он может работать в средах, чувствительных к приватности.",
  "home.privacy.learnMore": "Подробнее о",
  "home.privacy.link": "приватности",

  "home.faq.q1": "Что такое KronosCode?",
  "home.faq.a1":
    "KronosCode — это агент с открытым исходным кодом, который помогает писать и запускать код с любой AI-моделью. Доступен как терминальный интерфейс, десктопное приложение или расширение для IDE.",
  "home.faq.q2": "Как использовать KronosCode?",
  "home.faq.a2.before": "Проще всего начать с чтения",
  "home.faq.a2.link": "введения",
  "home.faq.q3": "Нужны ли дополнительные подписки на AI для использования KronosCode?",
  "home.faq.a3.p1":
    "Не обязательно, KronosCode поставляется с набором бесплатных моделей, которые можно использовать без создания аккаунта.",
  "home.faq.a3.p2.beforeZen":
    "Помимо этого, вы можете использовать любые популярные модели для кодинга, создав аккаунт",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хотя мы рекомендуем использовать Zen, KronosCode также работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",
  "home.faq.a3.p4.beforeLocal": "Вы даже можете подключить ваши",
  "home.faq.a3.p4.localLink": "локальные модели",
  "home.faq.q4": "Могу ли я использовать мои существующие AI-подписки с KronosCode?",
  "home.faq.a4.p1":
    "Да, KronosCode поддерживает подписки всех основных провайдеров. Вы можете использовать ваши подписки Claude Pro/Max, ChatGPT Plus/Pro или GitHub Copilot.",
  "home.faq.q5": "Можно ли использовать KronosCode только в терминале?",
  "home.faq.a5.beforeDesktop": "Больше нет! KronosCode теперь доступен как приложение для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "и",
  "home.faq.a5.web": "веба",
  "home.faq.q6": "Сколько стоит KronosCode?",
  "home.faq.a6":
    "KronosCode на 100% бесплатен. Он также включает набор бесплатных моделей. Дополнительные расходы могут возникнуть, если вы подключите другого провайдера.",
  ...
  "home.faq.q8": "KronosCode — это open source?",
  "home.faq.a8.p1": "Да, KronosCode полностью open source. Исходный код доступен публично на",
  "home.faq.a8.p2": "под",
  ...
  "home.zenCta.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые KronosCode протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве разных провайдеров, используйте проверенные модели, которые работают.",
  "home.zenCta.link": "Узнать о Zen",

  "zen.title": "KronosCode Zen | Набор надежных оптимизированных моделей для кодинг-агентов",
  "zen.hero.title": "Надежные оптимизированные модели для кодинг-агентов",
  "zen.hero.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые KronosCode протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве, используйте проверенные модели, которые работают.",

  "zen.faq.q1": "Что такое KronosCode Zen?",
  "zen.faq.a1":
    "Zen — это отобранный набор AI-моделей, протестированных и проверенных для кодинг-агентов командой, стоящей за KronosCode.",
  ...
  "zen.faq.a3":
    "Zen — некоммерческий проект. Zen транслирует расходы от провайдеров моделей вам. Чем больше использование Zen, тем лучшие тарифы KronosCode может согласовать и передать вам.",
  ...
  "zen.faq.a4.p3":
    "Для покрытия расходов KronosCode добавляет лишь небольшую комиссию за обработку платежа в размере $1.23 при пополнении баланса на $20.",
  ...
  "zen.faq.a8":
    "Хотя Zen отлично работает с KronosCode, вы можете использовать Zen с любым агентом. Следуйте инструкциям по настройке в вашем любимом агенте.",
  ...
  "zen.problem.subtitle": "Мы исправляем это для всех, а не только для пользователей KronosCode.",
  ...
  "zen.how.body": "Хотя мы предлагаем использовать Zen с KronosCode, вы можете использовать его с любым агентом.",
  ...
  "black.meta.title": "KronosCode Black | Доступ к лучшим моделям для кодинга в мире",
  "black.meta.description": "Получите доступ к Claude, GPT, Gemini и другим моделям с подпиской KronosCode Black.",
  "black.hero.title": "Доступ к лучшим моделям для кодинга в мире",
  "black.hero.subtitle": "Включая Claude, GPT, Gemini и другие",
  "black.title": "KronosCode Black | Цены",
  ...
  "black.workspace.title": "KronosCode Black | Выбор рабочего пространства",
  "black.workspace.selectPlan": "Выберите рабочее пространство для этого плана",
  "black.workspace.name": "Рабочее пространство {{n}}",
  "black.subscribe.title": "Подписаться на KronosCode Black",
  ...
  "black.subscribe.success.title": "Вы в списке ожидания KronosCode Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Используйте Zen с любым кодинг-агентом и продолжайте использовать других провайдеров с kronoscode, когда захотите.",
  ...
  "workspace.newUser.step.login.after": "и выберите kronoscode",
  "workspace.newUser.step.pasteKey": "Вставьте ваш API ключ",
  "workspace.newUser.step.models.before": "Запустите kronoscode и выполните",
  ...
  "workspace.keys.subtitle": "Управляйте вашими API ключами для доступа к сервисам kronoscode.",
  "workspace.keys.create": "Создать API ключ",
  "workspace.keys.placeholder": "Введите название ключа",
  "workspace.keys.empty": "Создайте API ключ для шлюза kronoscode",
  ...
  "workspace.black.subscription.message": "Вы подписаны на KronosCode Black за ${{plan}} в месяц.",
  ...
  "workspace.black.waitlist.joined": "Вы в списке ожидания плана KronosCode Black за ${{plan}} в месяц.",
  "workspace.black.waitlist.ready": "Мы готовы подключить вас к плану KronosCode Black за ${{plan}} в месяц.",
  ...
  "download.title": "KronosCode | Скачать",
  "download.meta.description": "Скачать KronosCode для macOS, Windows и Linux",
  "download.hero.title": "Скачать KronosCode",
  ...
  "download.section.extensions": "Расширения KronosCode",
  "download.section.integrations": "Интеграции KronosCode",
  ...
  "download.faq.a3.beforeLocal":
    "Не обязательно, но возможно. Вам понадобится AI подписка, если вы хотите подключить KronosCode к платному провайдеру, хотя вы можете работать с",
  ...
  "download.faq.a3.afterZen":
    ", KronosCode работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",

  "download.faq.a5.p1": "KronosCode на 100% бесплатен.",
  "download.faq.a5.p2.beforeZen":
    "Любые дополнительные расходы будут связаны с вашей подпиской у провайдера моделей. Хотя KronosCode работает с любым провайдером моделей, мы рекомендуем использовать",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваши данные и информация сохраняются только при создании ссылок для шеринга в KronosCode.",
  "download.faq.a6.p2.beforeShare": "Подробнее о",
  "download.faq.a6.shareLink": "страницах шеринга",

  "enterprise.title": "KronosCode | Корпоративные решения для вашей организации",
  "enterprise.meta.description": "Свяжитесь с KronosCode для корпоративных решений",
  "enterprise.hero.title": "Ваш код принадлежит вам",
  "enterprise.hero.body1":
    "KronosCode безопасно работает внутри вашей организации: не хранит данные и контекст, без лицензионных ограничений и претензий на собственность. Начните пробный период с командой, затем разверните по всей организации, интегрировав с SSO и внутренним AI-шлюзом.",
  ...
  "enterprise.faq.q1": "Что такое KronosCode Enterprise?",
  "enterprise.faq.a1":
    "KronosCode Enterprise предназначен для организаций, которые хотят гарантировать, что их код и данные никогда не покинут их инфраструктуру. Это достигается за счет централизованной конфигурации, интегрированной с вашим SSO и внутренним AI-шлюзом.",
  "enterprise.faq.q2": "Как начать работу с KronosCode Enterprise?",
  "enterprise.faq.a2":
    "Просто начните с внутреннего триала с вашей командой. KronosCode по умолчанию не хранит ваш код или контекстные данные, поэтому начать легко. Затем свяжитесь с нами, чтобы обсудить цены и варианты внедрения.",
  ...
  "enterprise.faq.q4": "Безопасны ли мои данные с KronosCode Enterprise?",
  "enterprise.faq.a4":
    "Да. KronosCode не хранит ваш код или контекстные данные. Вся обработка происходит локально или через прямые вызовы API к вашему AI-провайдеру. Благодаря централизованной конфигурации и интеграции SSO ваши данные остаются защищенными внутри инфраструктуры вашей организации.",

  "brand.title": "KronosCode | Бренд",
  "brand.meta.description": "Гайдлайны бренда KronosCode",
  "brand.heading": "Гайдлайны бренда",
  "brand.subtitle": "Ресурсы и активы, которые помогут вам работать с брендом KronosCode.",
  "brand.downloadAll": "Скачать все ресурсы",

  "changelog.title": "KronosCode | Список изменений",
  "changelog.meta.description": "Примечания к релизам и список изменений KronosCode",
  "changelog.hero.title": "Список изменений",
  "changelog.hero.subtitle": "Новые обновления и улучшения KronosCode",
