...
export const dict = {
  ...
  "notFound.title": "Non trovato | kronoscode",
  ...
  "home.title": "KronosCode | L'agente di coding IA open source",

  "temp.title": "kronoscode | Agente di coding IA costruito per il terminale",
  ...
  "home.what.title": "Che cos'è KronosCode?",
  "home.what.body": "KronosCode è un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, KronosCode è usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "KronosCode non archivia il tuo codice né i dati di contesto, così può operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di più su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'è KronosCode?",
  "home.faq.a1":
    "KronosCode è un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. È disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso KronosCode?",
  "home.faq.a2.before": "Il modo più semplice per iniziare è leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare KronosCode?",
  "home.faq.a3.p1":
    "Non necessariamente: KronosCode include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, KronosCode funziona anche con i provider più diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con KronosCode?",
  "home.faq.a4.p1":
    "Sì, KronosCode supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare KronosCode solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non più! KronosCode ora è disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa KronosCode?",
  "home.faq.a6":
    "KronosCode è gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "KronosCode è open source?",
  "home.faq.a8.p1": "Sì, KronosCode è completamente open source. Il codice sorgente è pubblico su",
  ...
  "home.zenCta.body":
    "Zen ti dà accesso a una selezione di modelli di IA che KronosCode ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",
  "home.zenCta.link": "Scopri Zen",

  "zen.title": "KronosCode Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti dà accesso a una selezione di modelli di IA che KronosCode ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'è KronosCode Zen?",
  "zen.faq.a1":
    "Zen è un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro KronosCode.",
  ...
  "zen.faq.a3":
    "Zen non è a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. Più Zen viene usato, più KronosCode può negoziare tariffe migliori e passarle a te.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, KronosCode aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con KronosCode, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti KronosCode.",
  ...
  "zen.how.body": "Anche se ti consigliamo di utilizzare Zen con KronosCode, puoi utilizzare Zen con qualsiasi agente.",
  ...
  "black.meta.title": "KronosCode Black | Accedi ai migliori modelli di coding al mondo",
  "black.meta.description":
    "Ottieni l'accesso a Claude, GPT, Gemini e altri con i piani di abbonamento KronosCode Black.",
  "black.hero.title": "Accedi ai migliori modelli di coding al mondo",
  "black.hero.subtitle": "Inclusi Claude, GPT, Gemini e altri",
  "black.title": "KronosCode Black | Prezzi",
  ...
  "black.workspace.title": "KronosCode Black | Seleziona Workspace",
  "black.workspace.selectPlan": "Seleziona un workspace per questo piano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Abbonati a KronosCode Black",
  ...
  "black.subscribe.success.title": "Sei nella lista d'attesa di KronosCode Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con kronoscode quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona kronoscode",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia kronoscode ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi kronoscode.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API kronoscode Gateway",
  ...
  "workspace.black.subscription.message": "Sei abbonato a KronosCode Black per ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.joined": "Sei nella waitlist per il piano KronosCode Black da ${{plan}} al mese.",
  "workspace.black.waitlist.ready": "Siamo pronti per iscriverti al piano KronosCode Black da ${{plan}} al mese.",
  ...
  "download.meta.description": "Scarica KronosCode per macOS, Windows e Linux",
  "download.hero.title": "Scarica KronosCode",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare KronosCode a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", KronosCode funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "KronosCode è gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre KronosCode funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in KronosCode.",
  "download.faq.a6.p2.beforeShare": "Scopri di più sulle",
  "download.faq.a6.shareLink": "pagine condivise",

  "enterprise.title": "KronosCode | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta KronosCode per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice è tuo",
  "enterprise.hero.body1":
    "KronosCode opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietà. Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'è KronosCode Enterprise?",
  "enterprise.faq.a1":
    "KronosCode Enterprise è per le organizzazioni che vogliono garantire che il loro codice e dati non lascino mai la loro infrastruttura. Può farlo usando una configurazione centralizzata che si integra con il tuo SSO e gateway IA interno.",
  "enterprise.faq.q2": "Come inizio con KronosCode Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. KronosCode per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono sicuri con KronosCode Enterprise?",
  "enterprise.faq.a4":
    "Sì. KronosCode non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "KronosCode | Brand",
  "brand.meta.description": "Linee guida del brand KronosCode",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand KronosCode.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "KronosCode | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog KronosCode",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a KronosCode",
