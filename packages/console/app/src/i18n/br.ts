...
export const dict = {
  ...
  "notFound.title": "Não encontrado | kronoscode",
  ...
  "home.title": "KronosCode | O agente de codificação de código aberto com IA",

  "temp.title": "kronoscode | Agente de codificação com IA feito para o terminal",
  ...
  "temp.feature.zen.afterLink": "fornecida pela kronoscode",
  ...
  "temp.screenshot.caption": "KronosCode TUI com o tema tokyonight",
  "temp.screenshot.alt": "KronosCode TUI com tema tokyonight",
  ...
  "home.what.title": "O que é KronosCode?",
  "home.what.body":
    "KronosCode é um agente de código aberto que ajuda você a escrever código no seu terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, KronosCode é usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.privacy.body":
    "KronosCode não armazena nenhum código seu nem dados de contexto, para que possa operar em ambientes sensíveis à privacidade.",
  "home.privacy.learnMore": "Saiba mais sobre",
  "home.privacy.link": "privacidade",

  "home.faq.q1": "O que é KronosCode?",
  "home.faq.a1":
    "KronosCode é um agente de código aberto que ajuda você a escrever e executar código com qualquer modelo de IA. Está disponível como interface de terminal, app desktop ou extensão de IDE.",
  "home.faq.q2": "Como eu uso o KronosCode?",
  "home.faq.a2.before": "A maneira mais fácil de começar é ler a",
  "home.faq.a2.link": "introdução",
  "home.faq.q3": "Preciso de assinaturas extras de IA para usar o KronosCode?",
  "home.faq.a3.p1":
    "Não necessariamente, KronosCode vem com um conjunto de modelos grátis que você pode usar sem criar conta.",
  "home.faq.a3.p2.beforeZen":
    "Além disso, você pode usar qualquer um dos modelos de codificação populares criando uma conta",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Embora incentivemos os usuários a usar o Zen, KronosCode também funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Você pode até conectar seus",
  "home.faq.a3.p4.localLink": "modelos locais",
  "home.faq.q4": "Posso usar minhas assinaturas de IA existentes com o KronosCode?",
  "home.faq.a4.p1":
    "Sim, KronosCode suporta planos de assinatura de todos os principais provedores. Você pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o KronosCode apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Não mais! KronosCode agora está disponível como um app para o seu",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o KronosCode?",
  "home.faq.a6":
    "KronosCode é 100% gratuito para usar. Ele também vem com um conjunto de modelos gratuitos. Pode haver custos adicionais se você conectar qualquer outro provedor.",
  ...
  "home.faq.q8": "KronosCode é código aberto?",
  "home.faq.a8.p1": "Sim, KronosCode é totalmente open source. O código-fonte é público no",
  ...
  "home.zenCta.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a KronosCode testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes entre provedores, use modelos validados que funcionam.",
  "home.zenCta.link": "Saiba mais sobre o Zen",

  "zen.title": "KronosCode Zen | Um conjunto selecionado de modelos confiáveis e otimizados para agentes de codificação",
  "zen.hero.title": "Modelos confiáveis e otimizados para agentes de codificação",
  "zen.hero.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a KronosCode testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes, use modelos validados que funcionam.",

  "zen.faq.q1": "O que é KronosCode Zen?",
  "zen.faq.a1":
    "Zen é um conjunto selecionado de modelos de IA testados e avaliados para agentes de codificação, criado pela equipe por trás do KronosCode.",
  ...
  "zen.faq.a3":
    "O Zen não tem fins lucrativos. O Zen repassa os custos dos provedores de modelos para você. Quanto maior o uso do Zen, mais a KronosCode pode negociar melhores taxas e repassá-las para você.",
  ...
  "zen.faq.a4.p3":
    "Para cobrir custos, a KronosCode adiciona apenas uma pequena taxa de processamento de pagamento de $1,23 por recarga de $20.",
  ...
  "zen.faq.a8":
    "Embora o Zen funcione muito bem com o KronosCode, você pode usar o Zen com qualquer agente. Siga as instruções de configuração no seu agente de codificação preferido.",
  ...
  "zen.problem.subtitle": "Estamos corrigindo isso para todos, não apenas para os usuários do KronosCode.",
  ...
  "zen.how.body": "Embora sugerimos que você use o Zen com o KronosCode, você pode usá-lo com qualquer agente.",
  ...
  "black.meta.title": "KronosCode Black | Acesse os melhores modelos de codificação do mundo",
  "black.meta.description": "Tenha acesso ao Claude, GPT, Gemini e mais com os planos de assinatura KronosCode Black.",
  ...
  "black.title": "KronosCode Black | Preços",
  ...
  "black.workspace.title": "KronosCode Black | Selecionar Workspace",
  "black.workspace.selectPlan": "Selecione um workspace para este plano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Assinar KronosCode Black",
  ...
  "black.subscribe.success.title": "Você está na lista de espera do KronosCode Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use o Zen com qualquer agente de codificação e continue usando outros provedores com kronoscode sempre que quiser.",
  ...
  "workspace.newUser.step.login.after": "e selecione kronoscode",
  "workspace.newUser.step.pasteKey": "Cole sua chave de API",
  "workspace.newUser.step.models.before": "Inicie o kronoscode e execute",
  ...
  "workspace.keys.subtitle": "Gerencie suas chaves de API para acessar os serviços kronoscode.",
  "workspace.keys.create": "Criar Chave de API",
  "workspace.keys.placeholder": "Digite o nome da chave",
  "workspace.keys.empty": "Crie uma chave de API do kronoscode Gateway",
  ...
  "workspace.black.subscription.message": "Você assina o KronosCode Black por ${{plan}} por mês.",
  ...
  "workspace.black.waitlist.joined": "Você está na lista de espera para o plano KronosCode Black de ${{plan}} por mês.",
  "workspace.black.waitlist.ready": "Estamos prontos para inscrever você no plano KronosCode Black de ${{plan}} por mês.",
  ...
  "download.title": "KronosCode | Baixar",
  "download.meta.description": "Baixe o KronosCode para macOS, Windows e Linux",
  "download.hero.title": "Baixar KronosCode",
  ...
  "download.section.extensions": "Extensões KronosCode",
  "download.section.integrations": "Integrações KronosCode",
  ...
  "download.faq.a3.beforeLocal":
    "Não necessariamente, mas provavelmente. Você precisará de uma assinatura de IA se quiser conectar o KronosCode a um provedor pago, embora você possa trabalhar com",
  ...
  "download.faq.a3.afterZen":
    ", o KronosCode funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "O KronosCode é 100% gratuito para usar.",
  "download.faq.a5.p2.beforeZen":
    "Quaisquer custos adicionais virão da sua assinatura de um provedor de modelo. Embora o KronosCode funcione com qualquer provedor de modelo, recomendamos o uso do",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Seus dados e informações só são armazenados quando você cria links compartilháveis no KronosCode.",
  "download.faq.a6.p2.beforeShare": "Saiba mais sobre",
  "download.faq.a6.shareLink": "páginas de compartilhamento",

  "enterprise.title": "KronosCode | Soluções empresariais para sua organização",
  "enterprise.meta.description": "Contate a KronosCode para soluções empresariais",
  "enterprise.hero.title": "Seu código é seu",
  "enterprise.hero.body1":
    "O KronosCode opera com segurança dentro da sua organização, sem dados ou contexto armazenados e sem restrições de licenciamento ou reivindicações de propriedade. Inicie um teste com sua equipe e, em seguida, implante em toda a organização integrando-o ao seu SSO e gateway de IA interno.",
  ...
  "enterprise.faq.q1": "O que é KronosCode Enterprise?",
  "enterprise.faq.a1":
    "KronosCode Enterprise é para organizações que desejam garantir que seu código e dados nunca saiam de sua infraestrutura. Isso pode ser feito usando uma configuração centralizada que se integra ao seu SSO e gateway de IA interno.",
  "enterprise.faq.q2": "Como faço para começar com o KronosCode Enterprise?",
  "enterprise.faq.a2":
    "Basta começar com um teste interno com sua equipe. O KronosCode por padrão não armazena seu código ou dados de contexto, facilitando o início. Em seguida, entre em contato conosco para discutir opções de preços e implementação.",
  ...
  "enterprise.faq.q4": "Meus dados estão seguros com o KronosCode Enterprise?",
  "enterprise.faq.a4":
    "Sim. O KronosCode não armazena seu código ou dados de contexto. Todo o processamento acontece localmente ou por meio de chamadas de API diretas para seu provedor de IA. Com configuração centralizada e integração de SSO, seus dados permanecem seguros dentro da infraestrutura de sua organização.",

  "brand.title": "KronosCode | Marca",
  "brand.meta.description": "Diretrizes da marca KronosCode",
  "brand.heading": "Diretrizes da marca",
  "brand.subtitle": "Recursos e ativos para ajudá-lo a trabalhar com a marca KronosCode.",
  "brand.downloadAll": "Baixar todos os recursos",

  "changelog.title": "KronosCode | Changelog",
  "changelog.meta.description": "Notas de versão e changelog do KronosCode",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Novas atualizações e melhorias no KronosCode",
