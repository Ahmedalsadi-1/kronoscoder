    ...
    <main data-page="home">
      ...
      <div data-component="content">
        <section data-component="top">
          <img data-slot="logo light" src={logoLight} alt="kronoscode logo light" />
          <img data-slot="logo dark" src={logoDark} alt="kronoscode logo dark" />
          ...
          <div data-slot="right">
            <button data-copy data-slot="command">
              <span>
                ...
                <span data-slot="highlight">kronoscode.ai/install</span>
                <span> | bash</span>
              </span>
              <CopyStatus />
            </button>
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>kronoscode-ai</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>kronoscode-ai</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                brew install <strong>kronoscode</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                paru -S <strong>kronoscode-bin</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://x.com/kronoscode">{i18n.t("footer.x")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/anomalyco/kronoscode">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://kronoscode.ai/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
