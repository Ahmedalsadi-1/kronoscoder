      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://kronoscode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>kronoscode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g kronoscode-ai")}>
                <code>
                  npm i -g <strong>kronoscode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g kronoscode-ai")}>
                <code>
                  bun add -g <strong>kronoscode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/kronoscode")}>
                <code>
                  brew install <strong>anomalyco/tap/kronoscode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S kronoscode")}>
                <code>
                  paru -S <strong>kronoscode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask kronoscode-desktop")}>
                <code>
                  brew install --cask <strong>kronoscode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
