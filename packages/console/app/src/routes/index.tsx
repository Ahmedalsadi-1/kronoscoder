                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">kronoscode-ai</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">anomalyco/tap/kronoscode</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  <Tabs.Content as="pre" data-slot="panel" value="paru">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">kronoscode</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
