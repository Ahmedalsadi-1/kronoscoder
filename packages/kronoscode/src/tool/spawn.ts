...
export const AgentSpawnTool = Tool.define("spawn_worker", {
  ...
  parameters: z.object({
    ...
    persona: z.enum(["architect", "security", "docs", "default"]).optional().describe("The persona for the worker agent"),
  }),
...
Please execute this task and report back.`,
    ...
    return {
      ...
      output: `Successfully spawned a worker agent in session ${child.id}. You can track its progress in the sidebar under child sessions.`,
