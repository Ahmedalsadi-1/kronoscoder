  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all KronosCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific KronosCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new KronosCode session for interacting with AI assistants and managing conversations.",
