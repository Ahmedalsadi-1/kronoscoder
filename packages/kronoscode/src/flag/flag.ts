...
export namespace Flag {
  ...
  export const KRONOSCODE_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS = number("KRONOSCODE_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS")
  ...
  export const KRONOSCODE_EXPERIMENTAL_PLAN_MODE = KRONOSCODE_EXPERIMENTAL || truthy("KRONOSCODE_EXPERIMENTAL_PLAN_MODE")
