...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kronoscode.git")).toEqual({ owner: "sst", repo: "kronoscode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kronoscode")).toEqual({ owner: "sst", repo: "kronoscode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kronoscode.git")).toEqual({ owner: "sst", repo: "kronoscode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kronoscode")).toEqual({ owner: "sst", repo: "kronoscode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kronoscode.git")).toEqual({ owner: "sst", repo: "kronoscode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kronoscode")).toEqual({ owner: "sst", repo: "kronoscode" })
})
