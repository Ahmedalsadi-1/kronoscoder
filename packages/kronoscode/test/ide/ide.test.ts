...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KRONOSCODE_CALLER", () => {
    process.env["KRONOSCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KRONOSCODE_CALLER", () => {
    process.env["KRONOSCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KRONOSCODE_CALLER", () => {
    process.env["KRONOSCODE_CALLER"] = "unknown"
