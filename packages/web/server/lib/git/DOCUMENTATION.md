...
- Random names use adjectives/nouns from `KRONOSCODE_ADJECTIVES` and `KRONOSCODE_NOUNS` lists.
- Branches created for new worktrees use `kronoschamber/<worktree-name>` pattern.
