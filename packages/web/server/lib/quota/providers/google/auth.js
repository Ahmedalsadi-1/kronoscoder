...
import { readAuthFile } from '../../../kronoscode/auth.js';
import { parseGoogleRefreshToken } from './transforms.js';

const ANTIGRAVITY_GOOGLE_CLIENT_ID =
  process.env.ANTIGRAVITY_GOOGLE_CLIENT_ID ?? process.env.GOOGLE_OAUTH_CLIENT_ID ?? '';
const ANTIGRAVITY_GOOGLE_CLIENT_SECRET =
  process.env.ANTIGRAVITY_GOOGLE_CLIENT_SECRET ?? process.env.GOOGLE_OAUTH_CLIENT_SECRET ?? '';
const GEMINI_GOOGLE_CLIENT_ID =
  process.env.GEMINI_GOOGLE_CLIENT_ID ?? process.env.GOOGLE_OAUTH_CLIENT_ID ?? '';
const GEMINI_GOOGLE_CLIENT_SECRET =
  process.env.GEMINI_GOOGLE_CLIENT_SECRET ?? process.env.GOOGLE_OAUTH_CLIENT_SECRET ?? '';
