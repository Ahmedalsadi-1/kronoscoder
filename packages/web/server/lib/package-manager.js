...
const PACKAGE_NAME = '@kronoscode-ai/web';
const NPM_REGISTRY_URL = `https://registry.npmjs.org/${PACKAGE_NAME}`;
const CHANGELOG_URL = 'https://raw.githubusercontent.com/btriapitsyn/kronoschamber/main/CHANGELOG.md';
...
function isPackageInstalledWith(pm) {
  try {
    ...
    return result.stdout.includes(PACKAGE_NAME) || result.stdout.includes('kronoschamber');
  } catch {
    return false;
  }
}
...
export async function checkForUpdates() {
  ...
  return {
    ...
    updateCommand: 'kronoschamber update',
  };
}
