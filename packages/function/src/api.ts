...
export default new Hono<{ Bindings: Env }>()
  ...
  .post("/exchange_github_app_token", async (c) => {
    const EXPECTED_AUDIENCE = "kronoscode-github-action"
  ...
  /**
   * Used by the GitHub action to get GitHub installation access token given user PAT token (used when testing `kronoscode github run` locally)
   */
  ...
  /**
   * Used by the kronoscode CLI to check if the GitHub app is installed
   */
