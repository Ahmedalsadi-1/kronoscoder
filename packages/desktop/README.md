...
Desktop application for the [KronosCode](https://kronoscode.ai) AI coding agent. Built with Tauri.
...
Download from [Releases](https://github.com/btriapitsyn/kronoschamber/releases).
...
```bash
git clone https://github.com/btriapitsyn/kronoschamber.git
cd kronoschamber
bun install
bun run desktop:dev
```
