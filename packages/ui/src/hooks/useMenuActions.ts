...
const MENU_ACTION_EVENT = 'kronoschamber:menu-action';
const CHECK_FOR_UPDATES_EVENT = 'kronoschamber:check-for-updates';
...
export const useMenuActions = (
  ...
  const handleAction = React.useCallback(
    (action: MenuAction) => {
      switch (action) {
        ...
        case 'copy': {
          const copyEvent = new Event('kronoschamber:copy', { cancelable: true });
  ...
  React.useEffect(() => {
    ...
    listen('kronoschamber:menu-action', (evt) => {
    ...
    listen('kronoschamber:check-for-updates', () => {
