        ...
        const builtInCommands: CommandInfo[] = [
          ...
          ...(hasSession  // Show when session exists, not when hasMessages
            ? [
                ...
                { name: 'agentmode', description: 'Set desktop mode: off, kronosos (browseros), desktop-browser, or e2b', isBuiltIn: true },
                { name: 'desktoptask', description: 'Run desktop task: user-desktop (full control) or e2b (background).', isBuiltIn: true },
              ]
            : []
          ),
