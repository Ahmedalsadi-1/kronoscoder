...
const useMarkdownShikiThemes = (): readonly [string | object, string | object] => {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('kronoschamber:vscode-shiki-themes', handler as EventListener);
    return () => window.removeEventListener('kronoschamber:vscode-shiki-themes', handler as EventListener);
  }, [getThemes, isVSCode]);
