...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/kronoscode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/kronoscode...\n")
...
console.log("Fetching npm all-time downloads for kronoscode-ai...\n")
const npmDownloads = await fetchNpmDownloads("kronoscode-ai")
